...
tf.flags.DEFINE_string('name', 'chinese_poetry', 'name of the model')
...
tf.flags.DEFINE_string('input_file', 'E:\\Neural-Network\\poetry_LSTM\\Char-RNN-TensorFlow\\data\\poetry.txt', 'utf8 encoded text file')
...
def main(_):
    model_path = os.path.join('E:\\Neural-Network\\poetry_LSTM\\Char-RNN-TensorFlow\\model\\', FLAGS.name)
