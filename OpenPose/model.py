...
def FCN_Handnet(imgsize = 48, acc_range = 3):
    ...
    stage1 = tl.layers.Conv2d(stage1, 64, (5,5), (1,1), act=tf.nn.relu, name='stage1_conv1')
    stage1 = tl.layers.Conv2d(stage1, 32, (5,5), (1,1), act=tf.nn.relu, name='stage1_conv2')
    stage1 = tl.layers.Conv2d(stage1, 6, (1,1), (1,1), act=tf.nn.relu, name='stage1_conv3')
    stage1_output = stage1.outputs #37
    stage1.print_layers
    stage1.print_params

    stage2 = tl.layers.InputLayer(tf.concat([features, stage1_output], 3), name='stage2_input')
    stage2 = tl.layers.Conv2d(stage2, 64, (5,5), (1,1), act=tf.nn.relu, name='stage2_conv1')
    stage2 = tl.layers.Conv2d(stage2, 32, (5,5), (1,1), act=tf.nn.relu, name='stage2_conv2')
    stage2 = tl.layers.Conv2d(stage2, 6, (1,1), (1,1), act=tf.nn.relu, name='stage2_conv3')
    stage2_output = stage2.outputs #53
    stage2.print_layers
    stage2.print_params

    stage3 = tl.layers.InputLayer(tf.concat([features, stage2_output], 3), name='stage3_input')
    stage3 = tl.layers.Conv2d(stage3, 64, (5,5), (1,1), act=tf.nn.relu, name='stage3_conv1')
    stage3 = tl.layers.Conv2d(stage3, 32, (5,5), (1,1), act=tf.nn.relu, name='stage3_conv2')
    stage3 = tl.layers.Conv2d(stage3, 6, (1,1), (1,1), act=tf.nn.relu, name='stage3_conv3')
    stage3_output = stage3.outputs #69
    stage3.print_layers
    stage3.print_params
    ...
    return train_op, img, label, [stage1_output, stage2_output, stage3_output], [stage1_loss, stage2_loss, stage3_loss], [stage1_acc, stage2_acc, stage3_acc]
